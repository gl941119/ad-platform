        ...
        <div class="advertisement-box">
            <div class="advertisement-box-content">
                <div class="advertisement-box-content-item">
                    <advert-item v-for="(advert, i) in advertDatas" :key="advert.id" :advert-datas="advert"  :item-index="((currpage?currpage:1)===1)?i:10" :system-time="sysTime" :is-white-back="true" @update-data="updateAdvertData"></advert-item>
