...
const zh = {
    ...
    forgetPassword: {
        ...
        finish: '完成',
        success: '密码修改成功',
        againLogin: '后将自动跳转到登录界面',
        pleaseEnterEmail: '请输入邮箱或手机号',
        enterCode: '请输入验证码',
    ...
    messageNotice: {
        emailEmpty: '邮箱或手机号不能为空',
        emailFormat: '邮箱或手机号格式不正确',
    ...
    share: {
        shareTiltle: '分享',
        shareOne: '被割了吗？来阿凡达，我养你啊！送上熊市屯币攻略，邀你注册瓜分99999个AFDT，填邀请码注册就送66AFDT ，每邀请一位再送33AFDT，每日挖币，再享分红！',
        shareCopy: '点我复制',
