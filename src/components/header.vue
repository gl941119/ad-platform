        ...
        <div class="header-content">
            ...
            <div class="header-content-tab clearfix">
                ...
                <div class="header-content-tab-right">
                    <div class="header-content-tab-right-item"><a href="javascript:;">EN</a><span>|</span></div>
                    <div class="header-content-tab-right-item"><a href="javascript:;">biertalk</a><span>|</span></div>
                    <div class="header-content-tab-right-item"><a href="javascript:;">帮助</a><span>|</span></div>
            ...
            <el-form class="register" :model="registerModel.form" ref="registerModelForm" :rules="registerModel.rule">
                <el-form-item label="邮箱"
                    ...
                    <el-input placeholder="请输入邮箱"
                              auto-complete="off"                              
                              v-model="registerModel.form.email"></el-input>
                </el-form-item>
                ...
                <el-form-item label="密码"
                    ...
                    <el-popover
                        ...
                        <el-input placeholder="请输入密码"
                                  ...
                                  slot="reference"
                                  type="password"
                                  v-model="registerModel.form.password"></el-input>
                    </el-popover>
                </el-form-item>
                <el-form-item label="确认密码"
                    ...
                    <el-input placeholder="请输入确认密码"
                              auto-complete="off"
                              type="password"
                              v-model="registerModel.form.passwordAgain"></el-input>
                </el-form-item>
                <el-form-item label="邀请码"
                              :label-width="registerModel.formLabelWidth">
                    <el-input placeholder="请输入邀请码,可选"
                              auto-complete="off"
                              v-model="registerModel.form.inviteCode"></el-input>
                </el-form-item>
        ...
        <el-dialog :title="'用户登录'" :lock-scroll="false" :close-on-click-modal="false" :visible.sync="loginModal.loginVisible" width="360px">
            <el-form class="login-modal" :model="loginModal.form" ref="loginModalForm">
                <el-form-item label="账号"
                              prop="email"
                              :label-width="loginModal.formLabelWidth">
                    <el-input placeholder="请输入账号"
                              auto-complete="off"                              
                              v-model="loginModal.form.email"></el-input>
                </el-form-item>
                <el-form-item label="密码"
                              prop="passwordAgain"
                              :label-width="loginModal.formLabelWidth">
                    <el-input placeholder="请输入密码"
                              auto-complete="off"
                              type="password"
                              v-model="loginModal.form.password"></el-input>
                </el-form-item>
                <el-form-item label="验证码"
                              prop="verifyCode"
                              class="login-verify"
                    ...
                    <el-input placeholder="输入验证码"
                              ...
                              v-model="loginModal.form.verifyCode"></el-input>
...
<script>
    ...
    export default {
        ...
        methods: {
            toLogin() {
                this.loginModal.loginVisible = true;
            ...
            handleLoginSucc(data){
                let { id, email, nickname, token, phone } = data;
